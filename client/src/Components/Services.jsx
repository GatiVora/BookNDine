  ...
  const data =[
    {
      ...
      subTitle: "Get best services through our application",
    },
    {
      icon:service2,
      title:"Covid Safe",
      subTitle: "We have all the curated restaurants that have all the precaution for a covid safe environment",
    },
    {
      icon:service3,
